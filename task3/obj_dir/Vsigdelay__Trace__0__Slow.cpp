...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+11,"RAM_SIZE", false,-1, 31,0);
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"rst", false,-1);
    tracep->declBit(c+3,"wr", false,-1);
    tracep->declBit(c+4,"rd", false,-1);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+9,((0xffU & ((IData)(vlSelf->sigdelay__DOT__wr_addr) 
                                      + (IData)(vlSelf->offset)))),8);
    bufp->fullIData(oldp+10,(8U),32);
    bufp->fullIData(oldp+11,(0x200U),32);
    bufp->fullCData(oldp+12,(vlSelf->sigdelay__DOT__rd_addr),8);
    bufp->fullBit(oldp+13,(vlSelf->sigdelay__DOT__incr));
    bufp->fullCData(oldp+14,(vlSelf->sigdelay__DOT__incr),8);
}
